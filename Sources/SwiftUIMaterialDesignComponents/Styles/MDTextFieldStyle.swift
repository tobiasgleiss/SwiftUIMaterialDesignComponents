...
public enum MDTextFieldStyle: Equatable {
    ...
    var focusedColor: Color {
        ...
        case let .filledSecured(color, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _): return color
        case let .outlined(color, _, _, _, _, _, _, _, _, _, _, _, _, _, _): return color
    ...
    var textColor: Color {
        ...
        case let .filledSecured(_, color, _, _, _, _, _, _, _, _, _, _, _, _, _, _): return color
        case let .outlined(_, color, _, _, _, _, _, _, _, _, _, _, _, _, _): return color
    ...
    var textColorDisabled: Color {
        ...
        case let .filledSecured(_, _, color, _, _, _, _, _, _, _, _, _, _, _, _, _): return color
        case let .outlined(_, _, color, _, _, _, _, _, _, _, _, _, _, _, _): return color
    ...
    var backgroundColor: Color {
        ...
        case let .filledSecured(_, _, _, color, _, _, _, _, _, _, _, _, _, _, _, _): return color
        case let .outlined(_, _, _, color, _, _, _, _, _, _, _, _, _, _, _): return color
    ...
    var backgroundColorDisabled: Color {
        ...
        case let .filledSecured(_, _, _, _, color, _, _, _, _, _, _, _, _, _, _, _): return color
        case let .outlined(_, _, _, _, color, _, _, _, _, _, _, _, _, _, _): return color
    ...
    var borderColor: Color {
        ...
        case let .filledSecured(_, _, _, _, _, color, _, _, _, _, _, _, _, _, _, _): return color
        case let .outlined(_, _, _, _, _, color, _, _, _, _, _, _, _, _, _): return color
    ...
    var borderColorDisabled: Color {
        ...
        case let .filledSecured(_, _, _, _, _, _, color, _, _, _, _, _, _, _, _, _): return color
        case let .outlined(_, _, _, _, _, _, color, _, _, _, _, _, _, _, _): return color
    ...
    var textFieldHeight: CGFloat {
        ...
        case let .filledSecured(_, _, _, _, _, _, _, height, _, _, _, _, _, _, _, _): return height
        case let .outlined(_, _, _, _, _, _, _, height, _, _, _, _, _, _, _): return height
    ...
    var errorFieldHeight: CGFloat {
        ...
        case let .filledSecured(_, _, _, _, _, _, _, _, height, _, _, _, _, _, _, _): return height
        case let .outlined(_, _, _, _, _, _, _, _, height, _, _, _, _, _, _): return height
    ...
    var errorMessageFontSize: CGFloat {
        ...
        case let .filledSecured(_, _, _, _, _, _, _, _, _, size, _, _, _, _, _, _): return size
        case let .outlined(_, _, _, _, _, _, _, _, _, size, _, _, _, _, _): return size
    ...
    var errorMessageColor: Color {
        ...
        case let .filledSecured(_, _, _, _, _, _, _, _, _, _, color, _, _, _, _, _): return color
        case let .outlined(_, _, _, _, _, _, _, _, _, _, color, _, _, _, _): return color
    ...
    var errorMessageBackgroundColor: Color {
        ...
        case let .filledSecured(_, _, _, _, _, _, _, _, _, _, _, color, _, _, _, _): return color
        case let .outlined(_, _, _, _, _, _, _, _, _, _, _, color, _, _, _): return color
    ...
    var cornerRadius: CGFloat {
        ...
        case let .filledSecured(_, _, _, _, _, _, _, _, _, _, _, _, radius, _, _, _): return radius
        case let .outlined(_, _, _, _, _, _, _, _, _, _, _, _, radius, _, _): return radius
    ...
    var padding: (horizontal: CGFloat, vertical: CGFloat) {
        ...
        case let .filledSecured(_, _, _, _, _, _, _, _, _, _, _, _, _, padding, _, _): return padding
        case let .outlined(_, _, _, _, _, _, _, _, _, _, _, _, _, padding, _): return padding
    ...
    var iconSize: CGSize {
        ...
        case let .filledSecured(_, _, _, _, _, _, _, _, _, _, _, _, _, _, size, _): return size
        case let .outlined(_, _, _, _, _, _, _, _, _, _, _, _, _, _, size): return size
